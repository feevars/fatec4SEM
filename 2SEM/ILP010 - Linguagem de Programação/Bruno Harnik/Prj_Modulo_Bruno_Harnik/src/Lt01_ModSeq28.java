...
public class Lt01_ModSeq28 {
    
    public static void main(String Args[]){
        
        double p, v;
        
        p = Double.parseDouble(JOptionPane.showInputDialog("Digite a média de venda mensal do produto: "));
        
        v = Double.parseDouble(JOptionPane.showInputDialog("Digite o preço atual desse produto em reais: "));
        
        NovoPreco(p,v);
    }
    
    public static void NovoPreco(double pAtual, double venda){
