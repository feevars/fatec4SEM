...
public class Nivel {
	...
	public Ladrilho getLadrilho(int x, int y) {
		...
		if (ladrilhos[x + y * largura] == 0xFF00FF00)
			return Ladrilho.grama;
		if (ladrilhos[x + y * largura] == 0xFFFF0000)
			return Ladrilho.flor;
		if (ladrilhos[x + y * largura] == 0xFF666666)
			return Ladrilho.pedra;
		return Ladrilho.ladrilhoVazio;
	}
